...
export const home3footerdata = [
    {
        title: 'Features',
        con1: 'Real-time Monitoring',
        con2: 'Analytics',
        con3: 'Demand Management',
    },
    {
        title: 'Benefits',
        con1: 'Cost Reduction',
...
export const home3card = [
    {
        img: 'url(/home3-card-img1.webp)',
        title: 'Commercial Buildings',
        subtitle: 'Optimize HVAC, Lighting, and Energy Usage',
    },
    {
        img: 'url(/home3-card-img2.webp)',
        title: 'Manufacturing Facilities',
        subtitle: 'Monitor and Manage Energy Consumption',
    },
    {
        img: 'url(/home3-card-img3.webp)',
        title: 'Retail Spaces',
        subtitle: 'Control and Optimize Energy Usage',
    },
    {
        img: 'url(/home3-card-img4.jpg)',
        title: 'Educational Institutions',
        subtitle: 'Track and Reduce Energy Consumption',
    },
]
...
export const industrialcard = [
    {
      bg:'url(/animation-img.png)',
      per:'20%',
      para:'Increased Efficiency',
    },
    {
        bg:'url(/animation-img.png)',
        per:'15%',
        para:'Boosted Profitability',
      },
      {
        bg:'url(/animation-img.png)',
        per:'99%',
        para:'Guaranteed Compliance',
      },
]



export const industrialfooterdata = [
    {
        title: 'Explore',
        con1: 'Features',
        con2: 'Benefits',
